...
export default function VendorProfilePage() {
  ...
  return (
    <div className="max-w-xl">
      <h1 className="text-2xl font-black mb-6 gradient-text">Vendor Profile</h1>
        ...
        <CardBody className="p-8">
          <div className="flex flex-col items-center gap-4 mb-6">
            <Avatar
              ...
              name={user.name}
              className="w-24 h-24 text-2xl ring-4 ring-purple-400"
              isBordered color="secondary"
            />
            <div className="text-center">
              <h2 className="text-xl font-bold">{user.name}</h2>
              <Chip color="secondary" variant="flat" size="sm" className="mt-1 capitalize">{user.role}</Chip>
            </div>
          </div>
